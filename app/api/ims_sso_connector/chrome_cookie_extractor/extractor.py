...
class ChromeCookieExtractor:
    ...
    def extract_cookies(self, domain: Optional[str] = None) -> List[Cookie]:
        ...
        """
        # NOTE: Chrome running check removed - copy_cookie_db() handles locked files
        # via Windows File Sharing API (win32file with FILE_FLAG_BACKUP_SEMANTICS)
        # This allows cookie extraction while Chrome is running
        ...
        try:
            ...
            # On Windows, uses win32file API to read locked database
