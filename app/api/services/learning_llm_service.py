            ...
            try:
                ...
                if self.auto_load:
                    ...
                    if loaded:
                        ...
                        logger.info(f"Learning LLM initialized with adapter: {self._adapter.current_adapter}")
                        return True
                    else:
...
async def initialize_learning_llm_service(
    ...
    logger.info(f"Learning LLM service initialized (enabled={enabled}, auto_load={auto_load})")
    return _learning_llm_service
