...
class EnhancementAnalystAgent(BaseAgent):
    ...
    def _get_default_prompt(self) -> str:
        ...
        return """You are an Enhancement Analyst Agent.
Analyze enhancement requests: classify type, assess priority, identify components.
Output structured JSON analysis with feasibility and complexity estimates."""
